...
class WhoisIpServerList implements IpServerListInterface
{
...
$writePath = __DIR__.'/../src/Resource/WhoisIpServerList.php';
$startTime = \microtime(true);

$ipv4Servers = require __DIR__.'/servers-updater/_parser_whois_ipv4_webpos.php';
$ipv6Servers = require __DIR__.'/servers-updater/_parser_whois_ipv6_webpos.php';
...
echo 'WHOIS servers updated. Now: '.$countIpv4.' Ipv4 and '.$countIpv6.' IPv6 servers'.\PHP_EOL;
